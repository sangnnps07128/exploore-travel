                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Booking Hotel Management</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                            ...
                            <table class="table table-centered table-striped table-bordered mb-0 toggle-circle" data-page-size="7">
                                ...
                                <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="/bookHotel/delete/{{$item->id_booking}}"><button class="demo-delete-row btn btn-danger btn-xs btn-icon"><i class="fe-trash"></i></button></a>
                                        </td>
                                </tr>
                                @endforeach
                                </tbody>
