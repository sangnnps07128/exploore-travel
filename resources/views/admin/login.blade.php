...
<!-- Mirrored from coderthemes.com/ubold/layouts/light/pages-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 04 Oct 2019 10:43:08 GMT -->
                        ...
                        <div class="card bg-pattern">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    <a href="index.html">
                                        <span><img src="http://exploore.info/public/client/img/logo/logo-black-color-1.png" alt="" height="22"></span>
                                    </a>
                                </div>
                                ...
                                @if( session('mess'))
                                <span class="text-center" style="color: red;">Thông tin đăng nhập không chính xác</span>
                                @endif
