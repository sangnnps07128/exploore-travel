                ...
                <div class="row">
                    <div class="col-lg-4 col-xl-4">
                        <div class="card-box text-center">
                            {{-- Lúc nào chọn avatar bỏ này vô {{asset('/upload/'.$result->avatar)}} --}}
                            <img src="{{asset('/public/upload/'.$result->avatar)}}" class="rounded-circle avatar-lg img-thumbnail"
                                 alt="profile-image">

                            <h4 class="mb-0" style="text-transform: capitalize;">{{$result->full_name}}</h4>
                            ...
                            <div class="text-left mt-3">
                                ...
                                <p class="text-muted mb-2 font-13"><strong>Full Name :</strong> <span class="ml-2" style="text-transform: capitalize;">{{$result->full_name}}</span></p>

                                <p class="text-muted mb-2 font-13"><strong>Mobile :</strong><span class="ml-2">{{$result->phone}}</span></p>

                                <p class="text-muted mb-2 font-13"><strong>Email :</strong> <span class="ml-2 ">{{$result->email}}</span></p>

                                <p class="text-muted mb-1 font-13"><strong>Location :</strong> <span class="ml-2">{{$result->address}}</span></p>
                            </div>
                        ...
                        <div class="card-box">
                            ...
                            <div class="inbox-widget slimscroll" style="max-height: 310px;">
                                <div class="inbox-item">
                                    <div class="inbox-item-img"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQEt91xfL_nvrTQiA0J207UZaBNd_xU6zjH6AxmOaVysBvwx0dW&s" class="rounded-circle" alt=""></div>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane show active" id="timeline">
                                    ...
                                    <div class="border border-light p-2 mb-3">
                                        <div class="media">
                                            <img class="mr-2 avatar-sm rounded-circle" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQEt91xfL_nvrTQiA0J207UZaBNd_xU6zjH6AxmOaVysBvwx0dW&s"
                                        ...
                                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQEt91xfL_nvrTQiA0J207UZaBNd_xU6zjH6AxmOaVysBvwx0dW&s" alt="post-img" class="rounded mr-1"
                                             height="60" />
                                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQEt91xfL_nvrTQiA0J207UZaBNd_xU6zjH6AxmOaVysBvwx0dW&s" alt="post-img" class="rounded mr-1"
                                             height="60" />
                                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQEt91xfL_nvrTQiA0J207UZaBNd_xU6zjH6AxmOaVysBvwx0dW&s" alt="post-img" class="rounded"
                                             height="60" />
                                    ...
                                    <div class="border border-light p-2 mb-3">
                                        ...
                                        <div class="post-user-comment-box">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <div class="media mt-3">
                                                        <a class="pr-2" href="#">
                                                            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQEt91xfL_nvrTQiA0J207UZaBNd_xU6zjH6AxmOaVysBvwx0dW&s" class="avatar-sm rounded-circle"
                                                                 alt="Generic placeholder image">
                                                        </a>
                                                        <div class="media-body">
                                            ...
                                            <div class="media mt-2">
                                                <a class="pr-2" href="#">
                                                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQEt91xfL_nvrTQiA0J207UZaBNd_xU6zjH6AxmOaVysBvwx0dW&s" class="rounded-circle"
