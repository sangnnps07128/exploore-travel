                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-horizontal" enctype="multipart/form-data"
                                      action="{{ url('news/addNews') }}" method="post">
                                    @csrf()
                                <input type="hidden" name="id_account" value="{{Auth::user()->id_account}}">
                                    <div class="form-group row mb-3">
                                        <label for="inputEmail3" class="col-3 col-form-label">Tiêu đề</label>
                                        <div class="col-9">
                                            <input type="text" class="form-control" id="inputEmail3" name="title_news">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="col-9">
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    ...
                                                    <label id="img_news" class="custom-file-label" for="inputGroupFile04"></label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-3">
                                        <label for="inputEmail3" class="col-3 col-form-label">Nội dung</label>
                                        <div class="col-9">
                                            <input type="text" class="form-control" id="inputEmail3" name="content_news">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-3">
