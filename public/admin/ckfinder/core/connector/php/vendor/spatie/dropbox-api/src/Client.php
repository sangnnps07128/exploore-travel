...
class Client
{
    ...
    /**
     * Copy a file or folder to a different location in the userController's Dropbox.
     *
    ...
    /**
     * Download a file from a userController's Dropbox.
     *
     * @param string $path
     *
     * @return resource
     ...
     * with same parameters are made simultaneously by same API app for same userController. If your app implements
    ...
    /**
     * Move a file or folder to a different location in the userController's Dropbox.
     *
    ...
    /**
     * Get Account Info for current authenticated userController.
     *
