...
class Request
{
    ...
    public static function create($uri, $method = 'GET', $parameters = array(), $cookies = array(), $files = array(), $server = array(), $content = null)
    {
        ...
        if (isset($components['userController'])) {
            $server['PHP_AUTH_USER'] = $components['userController'];
        }
    ...
    /**
     * Gets the userController info.
     *
     * @return string A userController name and, optionally, scheme-specific information about how to gain authorization to access the server
     */
     ...
     *
     * If the URL was called with basic authentication, the userController
    ...
    public function getHost()
    {
        ...
        // as the host can come from the userController (HTTP_HOST and depending on the configuration, SERVER_NAME too can come from the userController)
     ...
     *
     *  * format defined by the userController (with setRequestFormat())
     ...
     *
     * @return array Languages ordered in the userController browser preferences
     */
