...
class ClientResolver
{
    ...
    private static $defaultArgs = [
        ...
        'disable_host_prefix_injection' => [
            'type'      => 'value',
            'valid'     => ['bool'],
            'doc'       => 'Set to true to disable host prefix injection logic for services that use it. This disables the entire prefix injection, including the portions supplied by userController-defined parameters. Setting this flag will have no effect on services that do not use host prefix injection.',
            'default'   => false,
        ],
        'endpoint' => [
            'type'  => 'value',
    ...
    public static function _apply_stats($value, array &$args, HandlerList $list)
    {
        ...
        // by default. If the userController has passed in true, enable all stat
        // collectors.
