...
class BlobRestProxy extends ServiceRestProxy implements IBlob
{
    ...
    private function getMultipleUploadBlockSizeUsingContent($content)
    {
        ...
        if (Utilities::is64BitPHP()) {
            ...
            // If not, we could only honor userController's setting to determine
            // chunk size.
            $result = $this->blockSize;
        }
        return $result;
    ...
    /**
     * Returns only userController-defined metadata for the specified container.
     *
     * @param string                    $container name
     * @param Models\BlobServiceOptions $options   optional parameters
     *
    ...
    /**
     * Create promise to return only userController-defined metadata for the specified
     * container.
     *
     * @param string                    $container name
     * @param Models\BlobServiceOptions $options   optional parameters
