...
class ServiceRestProxy extends RestProxy
{
     ...
     *
     * @param  ServiceOptions  $serviceOptions The options userController passed in.
     *
     * @return MiddlewareStack
     */
    protected function createMiddlewareStack(ServiceOptions $serviceOptions)
    {
        //If handler stack is not defined by the userController, create a default
        //middleware stack.
        $stack = null;
     ...
     * @param array $metadata userController specified metadata
     *
     * @return array
     */
     ...
     *
     * @param array $metadata userController defined metadata.
     *
     * @return array
     */
    ...
    private static function addLocationHeaderToResponse(
        ...
        //that the userController have not set a retry middleware.
