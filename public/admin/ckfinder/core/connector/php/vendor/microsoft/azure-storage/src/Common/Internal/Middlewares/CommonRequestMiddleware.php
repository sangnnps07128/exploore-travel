...
class CommonRequestMiddleware extends MiddlewareBase
{
    ...
    protected function onRequest(RequestInterface $request)
    {
        ...
        //rewriting version and userController-agent.
        ...
        //Adding request-ID if not specified by the userController.
    ...
    /**
     * Gets the userController agent string used in request header.
     *
     * @return string
     */
