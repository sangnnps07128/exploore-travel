...
class CreateQueueOptions extends QueueServiceOptions
{
    ...
    /**
     * Gets userController defined metadata.
     *
     * @return array
     */
    ...
    /**
     * Sets userController defined metadata. This metadata should be added without the header
     * prefix (x-ms-meta-*).
     *
     * @param array $metadata userController defined metadata object in array form.
     *
     * @return void
     */
