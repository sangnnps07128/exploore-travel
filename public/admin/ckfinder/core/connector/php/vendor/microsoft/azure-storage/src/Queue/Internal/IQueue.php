...
interface IQueue
{
    ...
    /**
     * Returns queue properties, including userController-defined metadata.
     *
     * @param string                          $queueName The queue name.
     * @param QueueModels\QueueServiceOptions $options   The optional parameters.
     *
    ...
    /**
     * Creates promise to return queue properties, including userController-defined metadata.
     *
     * @param string                          $queueName The queue name.
     * @param QueueModels\QueueServiceOptions $options   The optional parameters.
     *
    ...
    /**
     * Sets userController-defined metadata on the queue. To delete queue metadata, call
    ...
    /**
     * Creates promise to set userController-defined metadata on the queue. To delete
